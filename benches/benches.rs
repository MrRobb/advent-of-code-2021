...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("Day 1 | Part 1", |b| {
        b.iter(|| day1::calculate_increases(&input1))
    });
    c.bench_function("Day 1 | Part 2", |b| {
        b.iter(|| day1::calculate_increases_sliding_window(&input1))
    });

    c.bench_function("Day 2 | Part 1", |b| {
        b.iter(|| day2::calculate_depth_and_position(&input2))
    });
    c.bench_function("Day 2 | Part 2", |b| {
        b.iter(|| day2::calculate_depth_and_position_and_aim(&input2))
    });

    c.bench_function("Day 3 | Part 1", |b| {
        b.iter(|| day3::calculate_power_consumption(&input3))
    });
    c.bench_function("Day 3 | Part 2", |b| {
        b.iter(|| day3::filter_power_consumption(&input3))
    });
}
